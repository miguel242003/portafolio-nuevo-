  ...
  return (
    <div className="whatIDO">
      <div className="what-box">
        <h2 className="title">
          L<span className="hat-h2">O QUE</span>
          <div>
        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Descripción</h4>
              <p>
                Construyo aplicaciones web modernas y escalables, desde el
                frontend hasta el backend, enfocado en rendimiento y calidad.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Automatización</div>
                <div className="what-tags">APIs</div>
                <div className="what-tags">Nginx</div>
                <div className="what-tags">Node.js</div>
                <div className="what-tags">Gunicorn</div>
                <div className="what-tags">Linux</div>
                <div className="what-tags">Git</div>
                <div className="what-tags">Seguridad 2FA/TOTP</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Descripción</h4>
              <p>
                Diseño interfaces intuitivas y experiencias visuales atractivas
